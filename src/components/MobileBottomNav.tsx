      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 px-3 pb-2 md:hidden">
        <nav className="flex items-center justify-around h-16 bg-background border border-border rounded-2xl shadow-lg">
          ...
          >
            ...
            <span className="text-[10px] font-normal uppercase tracking-wider">{t("mobile.wishlist")}</span>
            {wishlistItems > 0 && (
          ...
          >
            ...
            <span className="text-[10px] font-normal uppercase tracking-wider">{t("mobile.whatsapp")}</span>
          </a>
        </nav>
      </div>
    </>
